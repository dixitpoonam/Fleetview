					...
					if (TheSpeed.equalsIgnoreCase("0") || TheSpeed.equalsIgnoreCase("0.00")) {
						...
						else
						{
							...
							<tr style="background-color:#FFFFCC">
															<td><%=j%></td>
															<td><%=rsss.getString("VehicleRegNumber")%></td>
															<td><%=rsss.getString("vehtype")%></td>
															<td><%=dttim %></td>
															<td><%=rsss.getString("UnitID")%></td>
															<td><%=rsss.getString("Transporter")%></td>
															<td><%=rsss.getString("Location")%></td>
															<td><%=rsss.getString("TheSpeed")%></td>
															<td><%=rsss.getString("bcharging")%></td>
							</tr>
			</tbody>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Stop Report </h4>
