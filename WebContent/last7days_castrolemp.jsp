...
Statement st1,st2,st,st20,st21;
...
String SevenDaysAgo = session.getAttribute("7daysback").toString().substring(0,11) + " 00:00:00";
		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Last 7 Days Exception Report For Full Fleet <br><br>Exception
								Analysis Report For AVL Mobile Eye 2000 for
								<%=username%>
								For the Period: <%=SevenDaysAgo %>  to
								<%=Today%></h3>
					</div>
				</div>
			</div>
...
<button class="engage-help-toggle btn  btn-primary h-35px  btn-color-gray-700 btn-active-color-gray-900 shadow-sm rounded-top-0" data-bs-toggle="modal" data-bs-target="#SetCustomModal">
		...
		<td>5. Continuous Driving :>> 140 Mins With Stoppages<20</td>
