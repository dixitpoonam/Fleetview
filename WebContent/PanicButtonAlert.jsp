...
<%
	...
	Statement st=null, st1=null,st2=null,st20=null,st21=null,st3=null;
	String vehcode="", Latitude="", Longitude="", Location="";
		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Panic Button Alert Report From <%=datex1 %>
					...
					<div class="col-12">
						<div class="card">
							...
							<thead>
									...
									/* String sqlveh = "select distinct(vehiclecode) as vehcode from db_gps.t_vehicledetails where VehicleRegNumber='"+ss[0]+"'";
									ResultSet resveh = st2.executeQuery(sqlveh);
									if(resveh.next())
									{
									vehcode = 	resveh.getString("vehcode");
									String sqlloc="select LatinDec,LonginDec,TheFieldSubject from db_gps.t_veh"+vehcode+" where Thefielddatadatetime>='"+dttime+"' and Thefielddatadatetime<='"+dt1time+"'";
									ResultSet resvehloc = st3.executeQuery(sqlveh);
									if(resvehloc.next()){
										Latitude = resvehloc.getString("LatinDec");
										Longitude = resvehloc.getString("LonginDec");
										Location = resvehloc.getString("TheFieldSubject");
									} 
									} */
									...
									<tr>
											<td><%=i%></td>
											<td><%=ss[0] %></td>
											<td align="right"><%=ss[2] %></td>
											<td><%=ss[3] %></td>
									        <td><%= rs.getString("MailStatus") %></td>
									</tr>
									<%i++;}
									       %>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Panic Button Alert </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Panic Button Alert Report',
