...
<%-- 	    ajaxRequest.open("GET", "ReSet.jsp?call=SetDefault&reportno="+<%=reportno%>+"&tableheaders="+list+"&tableheaderslength="+(nodes.length/2), true);
 --%>	    
        ajaxRequest.open("GET", "ReSet.jsp?call=SetDefault&reportno=1019&tableheaders="+list+"&tableheaderslength="+(nodes.length/2), true);
		ajaxRequest.send(); 
		}
	}
...
{
	//for report conversion use this query
	String setdefault1="select * from db_gps.ColumnDisplayMaster where userid='default' and reportno='1019'";
...
System.out.println(" buttom :- "+bt);
	...
	if (bt== null || bt.equals("null")) {
		...
		System.out.println("ttime1: "+ttime1+" ttime2:"+ttime2);
		...
		<div class="content-header row">
			<div class="content-header-left col-md-3 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0"> My Health Report From <%=datex1 %>
						...
						<div class="card">
							...
							<thead>
										<tr>
											...
											<th>Cough</th>
								            <th>Fever</th>
								 			<th>DifficultiesInBreathing</th>
											<th>HadAnyOfTheFollowing</th>
											<th>ContactWithCOVID-19PositivePersonFromLast14Days</th>
									          ...
									          <%
												...
												%>
													...
													<tr>
														...
														<td align="right"><%=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(rs.getString("DateTime")))%></td>
														...
														<td align="left"><%=rs.getString("DoYouEverHadAnyOfTheFollowing")%></td>
														<td align="left"><%=rs.getString("HaveYouInContactWithCOVID19PositivePersonFromLast14Days")%></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for  My Health Report </h4>
						<button type="button" class="btn-close" data-bs-dismiss="modal"></button>
					</div>
			<%
			int kk=0; 
			//Str<%=kkng showList= "Sr No,Name,City,ID,VehNo";   //for Template Only 
