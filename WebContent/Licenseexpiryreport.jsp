...
<%
	...
	Statement st=null, st2=null,st3=null,st4=null,st20=null,st21=null;
...
String datex1, datex2, datenew11;
...
String Date2= session.getAttribute("Today").toString();
String Date3= session.getAttribute("Today").toString();
...
String sql1="select count(driverid) as Count2 from db_gps.t_drivers where (gpname  = '"+session.getAttribute("usertypevalue")+"'or owner='"+session.getAttribute("usertypevalue")+"') and activestatus='Active' and licenseexpdate >='"+Date1+"' and licenseexpdate<='"+Date2+"'";
ResultSet rst1=st2.executeQuery(sql1);
System.out.println(sql1);
  if(rst1.next())
   {       	CountOpt2=rst1.getString("Count2");
               
               System.out.println("Count2----------"+CountOpt2);
   }
	 ...
	 System.out.println(sql1);
       ...
       {       	CountOpt3=rst1.getString("Count3");
                   ...
                   System.out.println("Count3----------"+CountOpt3);
       }
				...
				if(Expired!=null)    //to handle null pointer exception
				{
				...
				if(Expired.equals("Expired"))
				{
					...
					//datex2=new SimpleDateFormat("dd-MMM-yyyy").format(new SimpleDateFormat("yyyy-MM-dd").parse(Date3));
					//System.out.println("Month---1111111"+Expired);
				 ...
				 if(Expired.equals("Week"))
				{
				    ...
				    datex1=new SimpleDateFormat("dd-MMM-yyyy").format(firstDateOfPrevious);
				    System.out.println("110firstDateOfcurrentsWeek:-"+datex1);
				    ...
				    datex2=new SimpleDateFormat("dd-MMM-yyyy").format(lastDateweek);
				    System.out.println("110lastDateOfcurrentWeek:-"+datex2);
				} 
				 ...
				 if(Expired.equals("7"))
					{
					    ...
					    System.out.println("122firstDateOfcurrentsMonth:-"+datex1);
					    ...
					    System.out.println("The current date is ROOOOOOOOOOOOOOOOOOOOOOOOOOOHHHHHHHHHHHHTTTTTTTTT: " + cal1.getTime());
					       ...
					       System.out.println("20 days later: " + cal1.getTime());
					    					    ...
					    					    datex2=new SimpleDateFormat("dd-MMM-yyyy").format(lastMonth1);
					    					    System.out.println("122lastDateOfcurrentMonth:-"+datex2);
...
<div class="app-content content ">
	...
	<div class="content-wrapper container-xxl p-0">
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Driver License Expiry Report</h3>
					</div>
				</div>
			</div>
		...
		changeMonth: true,
			...
			<div align="left">
			<label style="color:blue;">Expired:</label> <a href="Licenseexpiryreport.jsp?value=Expired"><%=CountOpt2 %></a>&nbsp;&nbsp;&nbsp;<label style="color:blue;">7 Days:</label>  :<a href="Licenseexpiryreport.jsp?value=7"><%=CountOpt3 %> </a><br>
			</div>
					...
					<div class="col-12">
						<div class="card">
							...
							<thead>
									...
									<%
									   int j=1;
									  String sql="select drivername,driverid,fathernm,owner,gpname,licenseno,mobileno,address1,DateOfInduction,activestatus, DATE_FORMAT(licenseexpdate,'%d-%b-%Y') as licenseexpdate from db_gps.t_drivers where (gpname='"+username+"' or owner='"+username+"') and activestatus='Active' and licenseexpdate>='"+dttime+"' and licenseexpdate<='"+dt1time+"'";
									  System.out.println("main sql:"+sql);
									  ResultSet rstMain=st4.executeQuery(sql);
									 while(rstMain.next())
									 {
										 %>
										 <tr>
										 <td><%=j++%></td>
										 <td><%=rstMain.getString("drivername")%></td>
										 <td><%=rstMain.getString("driverid")%></td>
										 <td><%=rstMain.getString("fathernm")%></td>
										 <td><%=rstMain.getString("owner")%></td>
										 <td><%=rstMain.getString("gpname")%></td>
										 <td><%=rstMain.getString("licenseno")%></td>
										 <td><%=rstMain.getString("mobileno")%></td>
										 <td><%=rstMain.getString("address1")%></td>
										 <td><%=rstMain.getString("DateOfInduction")%></td>
										 <td><%=rstMain.getString("activestatus")%></td>
										 <td align="right"><%=rstMain.getString("licenseexpdate")%></td>
										 </tr>
									 <% }%>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Driver License Expiry Report </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Driver License Expiry Report',
