		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Shipment Report From <%=datex1 %>
...
String veh="select * from db_gps.t_shipment where ShipmentDate>='"+dttime+"' and ShipmentDate<='"+dt1time+"'";
...
while(rs.next())
{	 
	String entdt=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(rs.getString("EntryDate")));
	String shipdt=new SimpleDateFormat("dd-MMM-yyyy HH:mm:ss").format(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").parse(rs.getString("ShipmentDate")));
...
%>
		...
		<tr>
			<td align="right"><%=i%></td>
			<td align="right"><%=rs.getString("ShipmentNumber")%></td>
			<td align="left"><%=rs.getString("Description")%></td>
			<td align="left"><%=rs.getString("RouteDescription")%></td>
			<td align="right"><%=shipdt%></td>
			<td align="right"> <%=rs.getString("ContainerId")%></td>
			<td align="left"><%=rs.getString("EntryBy")%></td>
			<td align="right"><%=entdt%></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Shipment Report </h4>
