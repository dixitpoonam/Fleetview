		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Main Disconnected Report From <%=datex1 %>
				...
				while (rsss.next()) {
					...
					if (TheSpeed.equalsIgnoreCase("0") || TheSpeed.equalsIgnoreCase("0.00")) {
						...
						if (bcharging.equalsIgnoreCase("OFF")) {
							...
							<tr>
								<td style="background-color:#FFC475" align="center"><%=j%></td>
								<td style="background-color:#FFC475" align="center"><%=rsss.getString("VehicleRegNumber")%></a></td>
								<td style="background-color:#FFC475" align="center"><%=rsss.getString("vehtype")%></td>
								<td style="background-color:#FFC475" align="center"><%= dttim%></td>
								<td style="background-color:#FFC475" align="center"><%=rsss.getString("UnitID")%></td>



								<td style="background-color:#FFC475" align="center"><%=rsss.getString("Transporter")%></td>

								<td style="background-color:#FFC475" align="center"><%=rsss.getString("Location")%></td>
								<td style="background-color:#FFC475" align="center"><%=rsss.getString("TheSpeed")%></td>
								<td style="background-color:#FFC475" align="center"><%=rsss.getString("bcharging")%></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Main Disconnected Report </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Main Disconnected Report',
