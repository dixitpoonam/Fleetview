			...
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						...
						Driver Incentive Report For Tanker Trips From  <%=datex1%>  To <%=datex2%>
						</h3> 
					</div>
				</div>
			</div>
...
%>
    ...
    <font size="2">Disclaimer : The Calculated Amount may change if there is a change in the status or count of Violation</font> 
...
<%
			...
			{
			 	sql="select * from db_gps.t_driverincentivedetails where primarytrips=0 and formonth>='"+dt+"'  and formonth <= '"+dt1+"' ORDER BY finalIncentive DESC,driverid  ";
			}
			else
			{
				sql="select * from db_gps.t_driverincentivedetails where primarytrips=0 and formonth>='"+dt+"'  and formonth <= '"+dt1+"'    and transporter = '"+usertypevalue+"'  ORDER BY finalIncentive DESC,driverid ";          
			}
...
%>
	...
	<tr>   
			<td align="right"><%=j++ %></td>
			<td align="right" >
			<a href="driverIncentiveShowTrips.jsp?driverid=<%=rs.getString("driverid")%>&category=tanker&month=<%=dt%>&month1=<%=dt1 %>" target="_blank"><%=rs.getString("driverid") %></a>
			</td>
			<td align="left" ><%=rs.getString("drivername") %></td>
			<td align="left"><%=rs.getString("transporter") %></td>
			<td align="right"><%=rs.getString("totaltrips") %></td>
			<td align="right"><%=rs.getString("totaldist") %></td>
			<!--<td style="text-align: right:" align="right">< %=rs.getString("tripsPoint") %></td>-->
			<td align="right"><%=rs.getString("tripswithzerodvi") %></td>
			...
			<td align="right"><%=rs.getString("totalincentive") %></td>
			<td align="right"><%=rs.getString("finalIncentive") %></td>
			<td align="center">
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Driver Incentive Details Tanker </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Driver Incentive Details Tanker',
