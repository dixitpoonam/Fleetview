...
%>
							...
							<tr>
								<tr>
								<td style="background-color:#CCFFCC" style="background-color:#CCFFCC" align="center"><%=j%></td>
								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("VehicleRegNumber")%></a></td>
								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("vehtype")%></td>
								<td style="background-color:#CCFFCC" align="center"><%=dttim%></td>
								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("UnitID")%></td>



								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("Transporter")%></td>

								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("Location")%></td>
								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("TheSpeed")%></td>
								<td style="background-color:#CCFFCC" align="center"><%=rsss.getString("bcharging")%></td>
...
%>
		...
		<!-- <tbody>
	 <tr>
                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">Summation</td>
                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  11</td>
                  			
                  			                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  </td>
                  			                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  </td>
                  			                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  </td>
                  			                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  </td>
                  			                  			                  			<td style="background-color:#CCFFCC" style="font-size: 13px; face:san-serif; color:black">  </td>
