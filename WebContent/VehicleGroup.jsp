...
<div class="app-content content ">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Vehicle Group Report</h3>
					</div>
				</div>
			</div>
				...
				<div class="row">
					<div class="col-12">
						<div class="card">
							...
							<thead>
										<tr>
            									<th style=" align:center;">Sr No</th>
            									<th style=" align:center;">Group</th>
								                <th style=" align:center;">Status</th>
								                <th style=" align:center;">Vehicles</th>
								        		<th style=" align:center;">Min Temp1</th>
								                <th style=" align:center;">Max Temp1</th>
								                <th style=" align:center;">Min Temp2</th>
								                <th style=" align:center;">Max Temp2</th>
								                <th style=" align:center;">Min Temp3</th>
								                <th style=" align:center;">Max Temp3</th>
								                <th style=" align:center;">Min Temp4</th>
								                <th style=" align:center;">Max Temp4</th>
								                <th style=" align:center;">Edit</th>
								                <th style=" align:center;">Deactivate</th>                                           
            							</tr>
									</thead>
   ...
   String VehicleList="";
	  ...
	  String type1=request.getParameter("status");
	//type="Customer";
	...
	else
	{
	    ...
	    %>
	<script>
	document.getElementById("status").value = '<% out.print(type1); %>';
	</script>
	<%
	  ...
	  {
	   if(Status1=="Active" || Status1=="Active" || Status1=="Active" || Status1.equalsIgnoreCase("Active"))
		{
		  active="Yes";
	  }
	   if(Status1=="DeActive" || Status1=="DeActive" || Status1=="DeActive" || Status1.equalsIgnoreCase("DeActive"))
		{
		  active="No";
	  }
	  }
	  String sql="select  GPName,count(*) as count,Active  from db_gps.t_group where VehCode in "+vehlist+" and Active='"+active+"' group by GPName ";
      ...
      while(rs4.next()){
    	  ...
    	  VehicleCount=rs4.getString("count"); 
    	  Status=rs4.getString("Active");
    	
    	  String sql1="select Mintemp1,Maxtemp1,Mintemp2,Maxtemp2,Mintemp3,Maxtemp3,Mintemp4,Maxtemp4 from db_gps.t_defaultvals where OwnerName='"+GPname+"'";

    //	  System.out.println("Query is : "+sql1);
    	  ps1 = conn.prepareStatement(sql1);
    	  rs14 = ps1.executeQuery();
    	  if(rs14.next())
    	  {
    		  MinSen1=rs14.getString("Mintemp1"); 
    		  MaxSen1=rs14.getString("Maxtemp1"); 
    		  MinSen2=rs14.getString("Mintemp2"); 
    		  MaxSen2=rs14.getString("Maxtemp2"); 
    		  MinSen3=rs14.getString("Mintemp3"); 
    		  MaxSen3=rs14.getString("Maxtemp3"); 
    		  MinSen4=rs14.getString("Mintemp4"); 
    		  MaxSen4=rs14.getString("Maxtemp4"); 
    	  }
	  
%>   	
			<tr>		          
			<td style="font-size: 11px;" align="right"><%=j %></td>
				<td style="font-size: 11px;" align="left"><a href="VehicleList.jsp?id=<%=GPname%>"><%=GPname %></a></td>
                 <td style="font-size: 11px;" align="left"><%=Status %></td>
                <td style="font-size: 11px;" align="right"><%=VehicleCount %></td>
                <td style="font-size: 11px;" align="right"><%=MinSen1 %></td>
                <td style="font-size: 11px;" align="right"><%=MaxSen1%></td>
                
                <td style="font-size: 11px;" align="right"><%=MinSen2 %></td>
                <td style="font-size: 11px;" align="right"><%=MaxSen2%></td>
                <td style="font-size: 11px;" align="right"><%=MinSen3 %></td>
                <td style="font-size: 11px;" align="right"><%=MaxSen3%></td>
                <td style="font-size: 11px;" align="right"><%=MinSen4 %></td>
                <td style="font-size: 11px;" align="right"><%=MaxSen4%></td>
<td style="font-size: 11px;" align="left"><a href="TempEditForm.jsp?gp=<%=GPname%>&mintemp1=<%=MinSen1%>&maxtemp1=<%=MaxSen1%>&mintemp2=<%=MinSen2%>&maxtemp2=<%=MaxSen2%>&mintemp3=<%=MinSen3%>&maxtemp3=<%=MaxSen3%>&mintemp4=<%=MinSen4%>&maxtemp4=<%=MaxSen4%>">Edit</a></td>                
          <td style="font-size: 11px;" align="left"><a href="VehicleGroupDeactivateAction.jsp?gp=<%=GPname%>" onclick="return confirm('Are you sure you want to Deactivate?');">Deactivate</a></td>                
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Vehicle Group Report </h4>
