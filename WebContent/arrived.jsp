		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Vehicle Arrived Report</h3>
					</div>
				</div>
			</div>
...
<%
	...
	{
		sql="select * from t_completedjourney where Endcode in "+locationlist+" and GPName='"+mainuser+"'  and StartDate >='"+dt+"'  and StartDate <='"+dt1+"' order by StartDate asc";
	}
	System.out.print(sql);
	ResultSet rst=st.executeQuery(sql);
	%>	
	
	<h3 class="content-header-title  mb-0">Vehicle Arrived
	<%
	...
	{
		out.print(" at "+session.getAttribute("Location").toString() +" From "+datex1+" to "+datex2);
	}
	%></h3>		
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Vehicle Arrived Report </h4>
