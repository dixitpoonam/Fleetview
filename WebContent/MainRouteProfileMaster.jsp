		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Route Profile Master</h3>
					</div>
				</div>
			</div>
					...
					<div class="col-12">
						<div class="card">
							...
							<tr>
									...
									<%
									int j=1;
									String sql = "select H.VehCode,D.VehicleRegNumber as VehicleRegNo, H.VehIdleAlertStatus as AlertStatus, DATE_FORMAT(H.updatedDateTime,'%d-%b-%Y %H:%i') as UpdatedDateTime  from db_gps.t_VehicleIdleAlertHistory H, db_gps.t_vehicledetails D where H.VehCode in "+vehlist+" and H.updatedDateTime>='"+dt+"' and H.updatedDateTime<= '"+dt1+"' and H.VehCode=D.VehicleCode order by H.updatedDateTime";
									System.out.println("main query:"+sql);
									ResultSet res = st1.executeQuery(sql);
									while(res.next()){
									%><tr>
									<td align="right"><%=j++%></td>
									<td align="left"><%=res.getString("VehicleRegNo")%></td>
									<td align="left"><%=res.getString("AlertStatus")%></td>
									<td align="right"><%=res.getString("UpdatedDateTime")%></td>
									</tr><%}%>
									</tbody>
									<tfoot>
								  <tr>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Route Profile Master </h4>
