		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Device Not Active Vehicle</h3>
					</div>
				</div>
			</div>
...
<form name="CountOfRecordsForm">
		...
		<div class="row col-12">
                    ...
                    <div class="col-md-2">
                        <a href="activeTrips.jsp"><span style="background-color:#FFFFFF; margin-left: -135px;">ActiveTrips</span></a>
                    </div>
                    <div class="col-md-2">
                        <a href="empdisconnected.jsp"><span style="background-color:#DCDCDC; margin-left: -223px;">Disconnected</span></a>
                    </div>
                    <div class="col-md-2">
                        <a href="missing.jsp"><span style="background-color:#FFC475; margin-left: -283px;">Missing </span></a>
                    </div>
                    <div class="col-md-1">
                        <a href="maindisconnected.jsp"><span style="background-color:#FFFFFF; margin-left: -303px;">Main Disconnected</span></a>
                    </div>
                </div>
		...
		%>	
			<!-- <tr bgcolor="#F0E68C">
		<td class="sorttable_nosort" width="15%"><b>Color Code Indications :&nbsp;&nbsp;<a href="currentposition2.jsp">Full Fleet</a></b></td>
		...
		<div class="row col-12">
                    ...
                    <div class="col-md-1 link">
                        <a href="moving.jsp"><span style="background-color:#CCFFCC; margin-left: -75px;">Moving</span></a> 
                    </div>
                    <div class="col-md-1">
                        <a href="stopped.jsp"><span style="background-color:#FFFFCC; margin-left: -95px;">Stop</span></a>
                    </div>
                    <div class="col-md-2">
                        <a href="activeTrips.jsp"><span style="background-color:#FFFFFF; margin-left: -135px;">ActiveTrips</span></a>
                    </div>
                    <div class="col-md-2">
                        <a href="disconnected.jsp"><span style="background-color:#DCDCDC; margin-left: -223px;">Disconnected</span></a>
                    </div>
                    <div class="col-md-2">
                        <a href="maindisconnected.jsp"><span style="background-color:#FFC475; margin-left: -283px;">Main Disconnection</span></a>
                    </div>
                    <div class="col-md-1">
                        <a href="notactive.jsp"><span style="background-color:#FFFFFF; margin-left: -303px;">InActive</span></a>
                    </div>
                </div>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Device Not Active Vehicle </h4>
