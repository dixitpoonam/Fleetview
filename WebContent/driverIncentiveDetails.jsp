...
System.out.println("Session name----------------->:"+user);
System.out.println("Session name2----------------->:"+usertypevalue);
...
System.out.println(" buttom :- "+bt);
	...
	if (bt== null || bt.equals("null")) {
		...
		datex2 = session.getAttribute("PresentMonthFirst").toString();
		...
		<div class="content-header row">
			<div class="content-header-left mb-1 col-md-3 col-12">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Driver Incentive Report For Primary And Secondary Trips From From <%=datex1 %>
							To <%=datex2 %></h3>
					</div>
				</div>
			</div>
...
{
 	sql="select * from db_gps.t_driverincentivedetails where tankertrips=0 and formonth>='"+dt+"'  and formonth <= '"+dt1+"' ORDER BY finalIncentive DESC,driverid ";
}
else
{
 	sql="select * from db_gps.t_driverincentivedetails where tankertrips=0 and formonth>='"+dt+"'  and formonth <= '"+dt1+"'  and transporter = '"+usertypevalue+"' ORDER BY finalIncentive DESC,driverid ";
}
...
<a href="driverIncentiveShowTrips.jsp?driverid=<%=rs.	getString("driverid")%>&category=prisec&month=<%=dt%>&month1=<%=dt1 %>" target="_blank"><%=rs.getString("driverid") %>
</a>
</td>
...
<td align="right"><div align="right"><a href="javascript:toggleDetails(<%=i %>,1,true);"><font size="2" ><%= rs.getString("finalIncentive")%></font>
				...
				<table border="1" bgcolor="#9db5e5" cellpadding="1px" cellspacing="1px" style="width: 8em;">
					<tr>
						<td>
						<div  align="left"><a href="IncentivePayment.jsp?driverid=<%=rs.getString("driverid")%>" target="_blank" onclick="javascript:toggleDetails(<%=i %>,2,false);">Payment Entry</a></div>
						</td>
					</tr>
					<tr>
						<td>
						<div  align="left"><a href="IncentivePaymentReport.jsp?driverid=<%=rs.getString("driverid")%>" target="_blank" onclick="javascript:toggleDetails(<%=i %>,2,false);">Payment Report </a></div>
						</td>
					</tr>
					<tr>
...
<% 
Integer totalincentive=Integer.parseInt(rs.getString("finalIncentive")) ;
Integer paidAmt= Integer.parseInt(rs.getString("paidAmt"));
Integer unpaidAmt=totalincentive-paidAmt;	
%>
<td style="text-align: right;" align="right"><%=unpaidAmt%></td>

<input type="hidden" id="unpaidAmt" name="unpaidAmt" value="<%=unpaidAmt%>">
</tr>
<%}
%>
										</tbody>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Driver Incentive Report </h4>
