...
<div class="app-content content ">
	...
	<div class="content-wrapper container-xxl p-0">
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Stopped Vehicle</h3>
					</div>
				</div>
			</div>
		...
		<div class="row col-12">
                    <div class="col-md-3">
                        <span style="background-color:#F0E68C">Color Code Indications :<a href="castrolempmain.jsp">Full Fleet</a></span>
                    </div>
                    ...
                    <div class="col-md-2">
                        <a href="removed.jsp"><span style="background-color:#BDEDFF; margin-left: -135px;">Removed</span></a>
                    </div>
                    
                    <div class="col-md-1">
                        <a href="notactive.jsp"><span style="background-color:#FFFFFF; margin-left: -283px;">Not Active</span></a>
                    </div>
                    <div class="col-md-1">
                        <input type="button" value="Hide Trip Info" onclick="showhide1();" class="engage-help-toggle btn  btn-primary h-35px  btn-color-gray-700 btn-active-color-gray-900 shadow-sm rounded-top-0" id="tdx" >
                    </div>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Stopped Vehicle </h4>
