		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Vehicle Idle Intimation Report From <%=datex1 %>
	...
	<div class="row col-12">
		...
		changeMonth: true,
			...
			<div class="col-md-4">
			    ...
			    <a href="VehicleIdleEntry.jsp"><button class="btn btn-primary" style="margin-top: 20px;" type="button">Add New</button></a>
			</div>
		</div><br>
			</form>
...
System.out.println("set setDefFlag "+setDefFlag);
...
<input type="hidden" id="setDefFlag" name="setDefFlag" value="<%=setDefFlag%>">
	...
	<div class="content-body">
		...
		<tr>
			...
			<th align="center">Vehicle Comment</th>
            <th align="center">Other Comment</th>
...
String veh="select a.SrNo,a.Vehcode,DATE_FORMAT(a.FromDate,'%d-%m-%Y') as FromDate,DATE_FORMAT(a.ToDate,'%d-%m-%Y') as ToDate,a.VehComment,a.OtherComment,a.EntryBy,DATE_FORMAT(a.updatedDateTime,'%d-%m-%Y %T') as UpdatedDateTime,b.VehicleRegNumber from db_gps.t_VehicleIdleEntry a inner join  db_gps.t_vehicledetails b on a.vehcode=b.vehiclecode where a.fromdate between '"+dt+"' and '"+dt1+"' and VehCode in "+vehlist+" and a.ActiveStatus='-'  ";
...
%>
		...
		<tr>
			...
			<td align="left"><a href="editVehIdleEntry.jsp?VehCode=<%=rs.getString("a.Vehcode")%>&SrNo=<%=rs.getString("a.SrNo")%>&VehComment=<%=rs.getString("a.VehComment")%>"><%=rs.getString("b.VehicleRegNumber") %></a></td>
			 <td align="center"><%=rs.getString("FromDate")%></td>
			<td align="center"><%=rs.getString("ToDate")%></td>
			<td align="left"><%=rs.getString("a.VehComment")%></td>
          	<td align="left"> <%=rs.getString("a.OtherComment")%></td>
			<td align="left"><%=rs.getString("a.EntryBy")%></td>
			<td align="center"><%=rs.getString("UpdatedDateTime")%></td>
			<td align="center"><a href="VehIdleDelete.jsp?fromDate=<%=datex1%>&VehCode=<%=rs.getString("a.Vehcode")%>&SrNo="<%=rs.getString("a.SrNo")%>>Delete</a></td>
		</tr>
		<%   kk++;
