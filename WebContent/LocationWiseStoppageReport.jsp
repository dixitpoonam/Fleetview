		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Location Wise Stoppage Report</h3>
					</div>
				</div>
			</div>
			...
			<section id="">
				...
				try {
					...
					if (LocationType.equals("All")) {
						sqlstop = "SELECT min( duration ) AS Min, max( duration ) AS Max, "
								...
								+"' AND todate <= '"
								+ dt1time
								+"' and Transporter='"+session.getAttribute("usertypevalue").toString()+"'group by Location order by Location asc";
					}
				...
				%>
						...
						<tr>
							...
							<td><%=j%></td>
							<td align="right"><%=rststop.getString("Location")%></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Location Wise Stoppage Report </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Location Wise Stoppage Report',
