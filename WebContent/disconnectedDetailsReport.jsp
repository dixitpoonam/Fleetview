...
<div class="app-content content ">
		...
		<div class="content-header row">
			<div class="content-header-left col-md-7 col-12 mb-2">
				<div class="row breadcrumbs-top">
					<div class="col-12">
						<h3 class="content-header-title  mb-0">Fleet Disconnection Report From <%=datex1 %>
							To <%=datex2 %> Of <%=username %>Vehicle Registration No.<%=VehicleRegNo%></h3>
					</div><input type="hidden" id="tableHTML" name="tableHTML" value="" />
				</div>
			</div>
	...
	<div class="content-body">
	     ...
	     //out.println("\n\n-->>sqlllllllll----....>>>>"+sql12);		
	        ResultSet rsSql=s.executeQuery(sql12);
			if(!rsSql.next()){
...
%>
	...
	<tr>
		...
		<td style="text-align: left"><a href="javascript: flase;"
			onClick="window.open ('shownewmap.jsp?lat=<%=fromLatitude%>&long=<%=fromLongitude%>&discription=<%=fromLocation%>', 'win1', 'width=600, height=550, location=0, menubar=0, scrollbars=0, status=0, toolbar=0, resizable=0'); javascript:toggleDetails1(<%=j%>,false);"><%=fromLocation%>
		</a></td>
		...
		<td style="text-align: left"><a href="javascript: flase;"
			onClick="window.open ('shownewmap.jsp?lat=<%=toLatitude%>&long=<%=toLongitude%>&discription=<%=toLocation%>', 'win1', 'width=600, height=550, location=0, menubar=0, scrollbars=0, status=0, toolbar=0, resizable=0'); javascript:toggleDetails1(<%=j%>,false);"><%=toLocation%>
		</a></td>
        ...
        <div class="modal-content">
				...
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Fleet Disconnection Report </h4>
