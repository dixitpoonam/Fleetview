		 ...
		 <div class="content-header row">
			 <div class="content-header-left col-md-7 col-12 mb-2">
				 <div class="row breadcrumbs-top">
					 <div class="col-12">
						 <h3 class="content-header-title  mb-0">Report For Routes available</h3>
					</div>
				</div>
			</div>
			<div class="content-header-right text-md-end col-md-5 col-12 d-md-block d-none">
				<div class="mb-1 breadcrumb-right">
                   ...
                   <a href="Addrouteentry.jsp"> <button id="detailedView" class="engage-help-toggle btn  btn-primary h-35px  btn-color-gray-700 btn-active-color-gray-900 shadow-sm rounded-top-0" >
	               Add New Route</button></a>
	 		     	<br>
	 			    <br>
<!-- Table Starts here -->
							...
							<table id="example1" class="table table-bordered">
							    ...
							    <tbody>
							        <%
										try{
										int j=1;
										String sql="select * from db_gps.t_castrolroutes where Owner='"+username+"'";
										...
										%>
												<tr>
													...
													<td align="left"><div align="left"><a href="KMLLoad.jsp?kmlfile=<%=rs.getString("kmlfile") %>"><%=rs.getString("kmlfile") %></a></div></td>
        ...
        <div class="modal-content">
				<!-- Modal Header -->
					<div class="modal-header">
						<h4 class="modal-title">Custom Column Selection for Report For Routes available </h4>
                        ...
                        buttons: [
                            {
								...
								title: 'Report For Routes available Template',
