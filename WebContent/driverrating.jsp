		...
		<div class="content-body">
			...
			<%
									 ...
									 try{ 
										...
										trans=trans+")";
										//out.print(trans);
									sql1="select * from t_driver_ds where TheDate='"+data2+"' and Distance between 100 and 250 and nd<>'Yes' and Jcode <>'-' and transporter in "+trans+" order by Rating, Distance desc limit 20";
...
System.out.println("sql1 3rd-->"+sql1);
...
<td align="right"><%=rst2.getString("Dcode")%></td>
<td align="left"><%=rst2.getString("Transporter")%></td>

<%
if(!jcode.equals("-"))
{
sql="select * from t_startedjourney where TripId='"+jcode+"'  and (TO_DAYS(CURDATE())-TO_DAYS(StartDate)) < 10";
System.out.println("sql jcode- "+sql);
...
<td align="right"><%=rst2.getString("OSCount")%></td>
<td align="right"><%=rst2.getString("RACount")%></td>
<td align="right"><%=rst2.getString("RDCount")%></td>
<td align="right"><%=rst2.getString("Distance")%></td>
<td align="right">
<%
					...
					<div class="col-12">
						<div class="card">
							...
							<thead>
									...
									System.out.println("sql1 4th: "+sql1);
...
System.out.println("sql1 5th: "+sql1);
...
<td align="right"><%=rst3.getString("Dcode")%></td>
...
{
sql="select * from t_startedjourney where TripId='"+jcode+"' and (TO_DAYS(CURDATE())-TO_DAYS(StartDate)) < 10";
System.out.println("sql jcode- 2nd :"+sql);
...
<td align="right"><%=rst3.getString("OSCount")%></td>
<td align="right"><%=rst3.getString("RACount")%></td>
<td align="right"><%=rst3.getString("RDCount")%></td>
<td align="right"><%=rst3.getString("Distance")%></td>
<td align="right">
<%
						...
						<div class="card">
							...
							<thead>
									...
									while(rst5.next()){
										...
										System.out.println("sql1 6th: "+sql1);
										...
										<td align="right"><%=rst5.getString("Dcode")%></td>
										<td align="left"><%=rst5.getString("Transporter")%></td>

										<%
										if(!jcode.equals("-"))
										{
										sql="select * from t_startedjourney where TripId='"+jcode+"' and (TO_DAYS(CURDATE())-TO_DAYS(StartDate)) < 10";
										System.out.println("sql1 7th: "+sql);
										...
										<td align="right"><%=rst5.getString("OSCount")%></td>
										<td align="right"><%=rst5.getString("RACount")%></td>
										<td align="right"><%=rst5.getString("RDCount")%></td>
										<td align="right"><%=rst5.getString("Distance")%></td>
										<td align="right">
										<%
